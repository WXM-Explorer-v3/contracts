...
import { WeatherXM } from "src/0.8.20/WeatherXM.sol";
import { IWeatherXM } from "src/0.8.20/interfaces/IWeatherXM.sol";
...
contract WeatherXMTest is Test {
  ...
  function testBurnFrom() public {
    ...
    assertEq(weatherXM.totalSupply(), maxSupply - 6 * 10 ** 18);
